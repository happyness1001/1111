...
public class ProductController {
    ...
    public String edit(Model model, int id, HttpSession hs) {
        ...
        hs.setAttribute("p", p);
        return "2cjsp/admin/admin_editProduct";
    }

    //商品提交
    @RequestMapping("submitProducts")
    public String submitProducts(Model model, int id, HttpSession hs) {
        Product p = productService.get(id);
        List<Category> cs = categoryService.list();
        Category cs1 = p.getCategory();
        model.addAttribute("p", p);
    ...
    public String list(int cid, Model model, Page page) {
        ...
        return "2cjsp/admin/listProduct";
    }

    @RequestMapping("group_config")
    public String group_config() {
        System.out.println(111);
        return "2cjsp/admin/1";
    }
