            ...
            $.get(
                ...
                function (result) {
                    if ("success" == result) {
                        var pid = ${p.id};
                        var num = $(".productNumberSetting").val();
                        var addGroupPage = "foreaddCart";
                        $.get(
                            addGroupPage,
                            {"pid": pid, "num": num},
                            function (result) {
                                if ("success" == result) {
                                    $(".addGroupButton").html("拼团成功");
                                    $(".addGroupButton").attr("disabled", "disabled");
                                    $(".addGroupButton").css("background-color", "lightgray")
                                    $(".addGroupButton").css("border-color", "lightgray")
                                    $(".addGroupButton").css("color", "black")
                                } else {
...
<div class="imgAndInfo">
    ...
    <div class="infoInimgAndInfo">
        ...
        <div class="buyDiv">
            ...
            <a href="#nowhere" class="groupBuying">
                <button class="addGroupButton"><span class="glyphicon glyphicon-shopping-cart"></span>开启团购</button>
            </a>
        </div>
