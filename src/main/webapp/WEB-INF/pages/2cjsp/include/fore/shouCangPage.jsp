<%@ page import="wzz.digou.pojo.Collection" %><%--
                    ...
                    <c:if test="${p.id==co.pid}">
                        ...
                        <tr class="orderItemProductInfoPartTR">
                            <td class="orderItemProductInfoPartTD"><img width="80" height="80"
                                                                        src="img/productSingle_middle/${p.imageName}">
                            </td>
                            ...
                            <td valign="top" rowspan="1" class="orderListItemNumberTD orderItemOrderInfoPartTD"
                                width="100px">
