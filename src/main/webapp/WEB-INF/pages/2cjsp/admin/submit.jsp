...
<div class="page-container" style="margin-top: 50px">
    <form class="form-horizontal" id="product_submit" action="" method="post">
        <input type="hidden" value="${p.id}" name="id" id="id">
        <%--<div class="form-group">`
            <label for="id" class="col-sm-offset-1 col-sm-2 control-label">
                <span class="text-danger">*&nbsp;</span>商品id：
            </label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="id" value="${p.id}" name="id" placeholder="商品id">
            </div>
        </div>--%>
        <div class="form-group">`
            <label for="shopid" class="col-sm-offset-1 col-sm-2 control-label">
                <span class="text-danger">*&nbsp;</span>商铺id：
            </label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="shopid" <%--value="${p.name}"--%> name="shopid"
                       placeholder="商铺id">
            </div>
        </div>
        <div class="form-group">
            <label for="pid" class="col-sm-offset-1 col-sm-2 control-label">
                <span class="text-danger">&nbsp;&nbsp;</span>商品id：
            </label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="pid" value="${p.id}" name="pid" placeholder="商品id">
            </div>
        </div>
        <%--  <div class="form-group">
        ...
        <div class="form-group">
            <label for="bulkprice" class="col-sm-offset-1 col-sm-2 control-label">
                <span class="text-danger">*&nbsp;</span>成团价格：
            </label>
            <div class="col-sm-4">
                <input type="text" class="form-control" id="bulkprice" <%--value="${p.originalPrice}"--%>
                       name="bulkprice" placeholder="成团价格">
            </div>
        </div>
        <div class="form-group">
            <label for="population" class="col-sm-offset-1 col-sm-2 control-label">
                <span class="text-danger">*&nbsp;</span>拼团人数：
            </label>
            <div class="col-sm-4">
                <input type="text" class="form-control" id="population" <%--value="${p.promotePrice}"--%>
                       name="population" placeholder="3">
            </div>
        </div>
        <div class="form-group">
            <label for="starttime" class="col-sm-offset-1 col-sm-2 control-label">
                <span class="text-danger">*&nbsp;</span>开始时间：
            </label>
            <div class="col-sm-4">
                <input type="text" class="form-control" id="starttime" <%--value="${p.stock}"--%> name="starttime"
                       placeholder="YYYY-MM-DD HH-MM-SS">
            </div>
        </div>

        <div class="form-group">
            <label for="endtime" class="col-sm-offset-1 col-sm-2 control-label">
                <span class="text-danger">*&nbsp;</span>结束时间：
            </label>
            <div class="col-sm-4">
                <input type="text" class="form-control" id="endtime" <%--value="${p.stock}"--%> name="endtime"
                       placeholder="YYYY-MM-DD HH-MM-SS">
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-3 col-sm-6">
                <button type="button" id="submitBtn" class="btn btn-primary radius">&nbsp;提交&nbsp;</button>
...
<script type="text/javascript">
    ...
    //保存发布
    //var form = $("#product_submit");
    $(document).ready(function () {
        //验证
        $("#product_submit").bootstrapValidator({
    ...
    $("#submitBtn").click(function () { //进行表单验证
        $("#product_submit").bootstrapValidator('validate');
        var bv = $("#product_submit").data('bootstrapValidator');
        bv.validate();
        if (bv.isValid()) {
            var index = layer.load(3);
            editor.sync();
//            console.log($("#product_submit").serialize());
            //发送ajax请求
            $.ajax({
        ...
        editor = K.create('textarea[name="detailed"]', {
            ...
            afterCreate: function () {
                ...
                K.ctrl(document, 13, function () {
                    self.sync();
                    document.forms['product_submit'].submit();
                });
