...
<div class="admin-biaogelist">
                ...
                <ul id="treeDemo" class="ztree">
                    ...
                    <c:forEach items="${cs}" var="c">
                        <li class="level0" tabindex="0" hidefocus="true" treenode="">
                            ...
                            <a class="level0" treenode_a="" onclick="editCategory(${c.id})" target="_blank" style=""
                               title="点击进行编辑">
                    ...
                    <form class="form-horizontal" id="category-add" action="" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-6">
                                <button type="button" id="submitBtn" class="btn btn-primary radius">&nbsp;添加分类&nbsp;
                                </button>
                            </div>
                        </div>
                    </form>
    ...
    <div class="foods">
        <p>版权所有@2018 农村集采商城 <a href="#" target="_blank" title="农村集采商城">农村集采商城</a></p>
    </div>
