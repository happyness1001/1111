...
<div class="admin-biaogelist">
        ...
        <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            ...
            <c:forEach items="${ps}" var="p">
                <tr>
                    ...
                    <td>
                        <a href="javascript:;" onclick="submitProducts(${p.id})">
                            <button type="button" class="am-btn am-btn-danger am-round am-btn-xs am-icon-plus">
                                提交
                            </button>
                        </a>
    ...
    <div class="foods">
        <p>版权所有@2018 商城 <a href="#" target="_blank" title="地狗商城">商城</a></p>
    </div>
...
<script>
    ...
    function submitProducts(id) {
        //弹出即全屏
        var index = layer.open({
            type: 2,
            title: '提交商品',
            content: 'submitProducts?id=' + id,
            area: ['320px', '195px'],
            maxmin: true
        });
        layer.full(index);
