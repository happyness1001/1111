...
<div id="main">
                    ...
                    <div id="rev_slider" class="rev_slider fullscreenbanner">
                        <ul>
                            <li data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                                ...
                                <img src="img/slider/slide_bg_4.jpg" alt="" data-bgposition="center center"
                                ...
                                <div class="tp-caption rs-parallaxlevel-2"
                                    ...
                                    <img src="img/slider/slide_6.png" alt=""/>
                                </div>
                                <div class="tp-caption rs-parallaxlevel-1"
                                    ...
                                    <img src="img/slider/slide_7.png" alt=""/>
                                </div>
                            ...
                            <li data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                                data-hideslideonmobile="off" data-easein="default" data-easeout="default"
                                data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide">
                                <img src="img/slider/slide_bg_5.jpg" alt="" data-bgposition="center center"
                                     data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off"
                                     class="rev-slidebg"/>
                                <div class="tp-caption rs-parallaxlevel-1"
                                     data-x="center" data-hoffset=""
                                     ...
                                     data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                     data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]">
                                    <img src="img/slider/slide_8.png" alt=""/>
                                </div>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="section section-bg-1 section-cover pt-17 pb-3">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="mt-3 mb-3">
                        <img src="img/oranges.png" alt=""/>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="mb-1 section-pretitle default-left">Welcome to</div>
                    <h2 class="section-title mtn-2 mb-3">新零售商城</h2>
                    <p class="mb-4">
                        为支持新型商贸连锁服务模式构建，打造全新集采模式和零售体系，新零售商城围绕课题总体需求，通过关键技术攻坚，解决了村镇社区商贸零售采购系统在设计研发阶段的问题，现系统正式上线.
                    </p>
                    <a class="organik-btn arrow" href="#">去逛逛</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="text-center">
                        <div class="mb-1 section-pretitle white">限时活动位置</div>
                        <h2 class="section-title mtn-2 mb-3">放置商品名称</h2>
                        <p class="white mb-4">
                            放置商品描述和内容
                        </p>
                        ...
                        <a class="organik-btn brown" href="#">立即抢购</a>
                    </div>
                </div>
                <div class="col-sm-6">
                            ...
                            <div id="collapse1" class="accordion-body collapse in">
                                <div class="accordion-inner">
                                    <p>
                                        ...
                                        nourished with sustainable practices by responsible standards. Organic farming
                            ...
                            <div id="collapse2" class="accordion-body toggle_content collapse">
                                <div class="accordion-inner">
                                    <p>
                                        ...
                                        interventions on the agro-ecosystem. It aims to produce food while establishing
                                        an ecological balance to prevent soil fertility or pest problems. Organic
                                        agriculture takes a proactive approach as opposed to treating problems after
                                        they emerge.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div id="collapse3" class="accordion-body toggle_content collapse">
                                <div class="accordion-inner">
                                    <p>
                                        ...
                                        energy cycling for agricultural production.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="blog-grid-item">
                        ...
                        <div class="post-content">
                            ...
                            <div class="entry-content">
                                Cut the halves into smaller pieces and place in a large pot of water with a steam basket
                                to keep the pumpkin pieces from touching…
                            </div>
                ...
                <div class="col-md-4">
                    <div class="blog-grid-item">
                        ...
                        <div class="post-content">
                            ...
                            <div class="entry-content">
                                A fridge full of organic vegetables purchased or harvested with the best of intentions,
                                and then life gets busy, leaving no time to peel,
                            </div>
                            <div class="entry-more">
                                <a href="#">Read more</a>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="blog-grid-item">
                        ...
                        <div class="post-content">
                            ...
                            <div class="entry-content">
                                Organic food consumption is rapidly increasing. The heightened interest in the global
    ...
    <div class="section pt-2 pb-4">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="client-carousel" data-auto-play="true" data-desktop="5" data-laptop="3" data-tablet="3"
                         data-mobile="2">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.isotope.init.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/script.js"></script>

<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.themepunch.tools.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.themepunch.revolution.min.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/js/extensions/revolution.extension.video.min.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/js/extensions/revolution.extension.slideanims.min.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/js/extensions/revolution.extension.actions.min.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/js/extensions/revolution.extension.kenburn.min.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/js/extensions/revolution.extension.navigation.min.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/js/extensions/revolution.extension.migration.min.js"></script>
<script type="text/javascript"
        src="${pageContext.request.contextPath}/js/extensions/revolution.extension.parallax.min.js"></script>
