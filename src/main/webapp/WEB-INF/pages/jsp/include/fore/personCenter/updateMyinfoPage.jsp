        ...
        <div class="col-md-4 col-md-offset-4">
            ...
            <form name="" id="" action="member-updateselfinfo.do" method="post">
                ...
                <div class="form-group ">
                    ...
                    <input name="id" type="hidden" class="form-control" onblur="ischeckNum()" id="id"
                ...
                <div class="form-group ">
                    ...
                    <input name="member_phone" type="text" class="form-control" onblur="ischeckNum()" id="tel"
                           value="${current_member.member_phone}">
                    <p id="phoneInfo"></p>
                </div>
                <div class="form-group ">
                ...
                <div class="form-group ">
                    ...
                    <input name="member_name" type="text" class="form-control" onblur="checkName()" id="username"
                           value="${current_member.member_name}">
                    <p id="userInfo"></p>
                </div>

                <div class="form-group ">
                    <label for="address">地址</label>
                    <input name="member_address" type="text" class="form-control" id="address" onblur="checkAddr()"
                           value="${current_member.member_address}">
                    <p id="addrInfo"></p>
                </div>
