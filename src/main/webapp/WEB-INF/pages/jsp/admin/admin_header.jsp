...
<div class="am-cf admin-main">
    ...
    <div class="nav-navicon admin-main admin-sidebar">
        ...
        <div class="sideMenu">
            ...
            <ul>
                <li><a href="${pageContext.request.contextPath}/admin_user_list">会员列表</a></li>
            </ul>

            <h3 class="am-icon-users"><em></em> <a href="#">商品管理</a></h3>
            <ul>
                <li><a href="${pageContext.request.contextPath}/admin_product_listAll">商品列表</a></li>
                <li><a href="${pageContext.request.contextPath}/toCategory">分类管理</a></li>

            </ul>

            <h3 class="am-icon-cart-plus"><em></em> <a href="#">收藏管理</a></h3>
            <ul>
                <li><a href="${pageContext.request.contextPath}/showAllCollection">收藏记录</a></li>
            </ul>

            <h3 class="am-icon-cart-plus"><em></em> <a href="#">订单管理</a></h3>
            <ul>
                <%--<a class="navbar-brand" href="admin_order_list">订单管理</a>--%>
                <li><a href="${pageContext.request.contextPath}/admin_showAllOrder">全部列表</a></li>
