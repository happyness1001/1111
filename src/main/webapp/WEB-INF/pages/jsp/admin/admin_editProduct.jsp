    ...
    <form class="form-horizontal" id="product-edit" action="" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                <c:if test="${!empty p.subTitle}">
                    <input type="text" class="form-control" id="subTitle" value="${p.subTitle}" name="subTitle"
                           placeholder="商品简述">
                </c:if>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="originalPrice" value="${p.originalPrice}"
                       name="originalPrice" placeholder="请输入正确的价格">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="promotePrice" value="${p.promotePrice}" name="promotePrice"
                       placeholder="请输入正确的价格">
            </div>
        </div>
        <div class="form-group">
