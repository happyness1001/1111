...
<%@ page import="wzz.digou.pojo.User" %>
            ...
            <c:if test="${os!=null}">
                <c:forEach items="${os}" var="o">
                    <tr>
                        ...
                        <td>
                            <center><fmt:formatDate value="${o.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/></center>
                        </td>
                        <td>
                            <center><fmt:formatDate value="${o.payDate}" pattern="yyyy-MM-dd HH:mm:ss"/></center>
                        </td>
                        <td>
                            <center><fmt:formatDate value="${o.deliveryDate}" pattern="yyyy-MM-dd HH:mm:ss"/></center>
                        </td>
                        <td>
                            <center><fmt:formatDate value="${o.confirmDate}" pattern="yyyy-MM-dd HH:mm:ss"/></center>
                        </td>
                        <td>
                            <center>${o.statusDesc}</center>
                        </td>
                        <td>
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    ...
                                    <c:if test="${o.statusDesc eq '完成'}">
                                                <span
                                                        class="am-btn am-btn-default am-btn-xs am-text-secondary am-round"
                                                        title="已发货"><span class=" glyphicon glyphicon-cd"
                                    ...
                                    <c:if test="${o.statusDesc eq '删除'}">
                                                 ...
                                                 <span
                                                         class="am-btn am-btn-default am-btn-xs am-text-secondary am-round"
                                                         title="已删除"><span class=" glyphicon glyphicon-remove-sign"
                                                                           aria-hidden="true"></span>
                                                </span>
                                    ...
                                    <c:if test="${o.statusDesc eq '待收货'}">
                                                <span
                                                        class="am-btn am-btn-default am-btn-xs am-text-secondary am-round"
                                                        title="待收货"><span class="glyphicon glyphicon-cd"
                                                                          aria-hidden="true"></span>
                                                </span>
