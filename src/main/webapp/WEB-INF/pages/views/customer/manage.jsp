                                ...
                                <table class="table table-hover">
                                    ...
                                    <c:forEach items="${pageInfo.list}" var="customer">
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-success" onclick="window.location.href='/customer/get?customerId=${customer.customerId}'">更 新</button>
                                                <button type="button" class="btn btn-sm btn-danger" onclick="deleteCustomer(${customer.customerId})">删 除</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
