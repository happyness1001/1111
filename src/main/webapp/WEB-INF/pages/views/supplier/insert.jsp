                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="supplierName" class="form-control" placeholder="请输入供货商名称">
                            </div>
                            <label>供货商电话</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                <input type="text" name="supplierPhone" class="form-control" placeholder="请输入供货商电话">
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="supplyCategory" class="form-control" placeholder="请输入供货类别">
                            </div>
                            <label>质量</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                <input type="text" name="quality" class="form-control" placeholder="请输入供货质量评级">
                            </div>
                            <label>价格</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                <input type="text" name="price" class="form-control" placeholder="请输入供货价格评级">
                            </div>
                            <label>数量</label>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                <input type="text" name="quantity" class="form-control" placeholder="请输入供货数量评级">
                            </div>
                            <button type="button" class="btn btn-block btn-info" onclick="insertSupplyRecord()">新增供货记录</button>
                        </div>
                    </div>
                </div>
            </div>
